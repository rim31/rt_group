...
/*   Updated: 2016/06/02 14:51:52 by oseng            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		if (!rt->object[i].negativ)
			if ((rt->object[i].name == SPHERE && sphere(ray, rt->object[i], &rt->t,
				...
				(rt->object[i].name == TRIANGLE && triangle(ray, rt->object[i], &rt->t,
					origin)) ||
				(rt->object[i].name == TORUS && torus(ray, rt->object[i], &rt->t,/*<torus ============================================*/
					origin)) ||
				(rt->object[i].name == QUADRIC && quadric(ray, rt->object[i], &rt->t,/*<quadric ============================================*/
					origin)) ||
